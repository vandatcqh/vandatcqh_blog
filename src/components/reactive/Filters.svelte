...
{#snippet filter(title: string)}
    <button onclick={() => removeFilter(title)} class="group hover:cursor-pointer hover:opacity-60 duration-200">
...
{#if $filters.length > 0}
    <div class="flex gap-4 p-2 pl-4 pb-0 opacity-75">
        <svg class="w-4 h-4 my-auto stroke-primary-foreground" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
