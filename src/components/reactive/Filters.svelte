...
{#snippet filter(title: string)}
    <button onclick={() => removeFilter(title)} in:slide class="group hover:cursor-pointer hover:opacity-60 duration-200">
...
{#if $filters.length > 0}
    <div in:slide class="flex gap-4 p-4 pb-0 opacity-75">
